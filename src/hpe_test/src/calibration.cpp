...
namespace hpe_test{
    ...
    const Eigen::Matrix4f&              Calibration::getExtrinsics()    const {return extrinsics_;};
    const Eigen::Matrix<float, 3, 4>&   Calibration::getIntrinsics()    const {return intrinsics_;};
    const Eigen::Matrix<float, 3, 4>&   Calibration::getProjection()    const {return projection_;};
    const Eigen::Matrix<float, 3, 4>&   Calibration::getM()             const {return projection_;};
